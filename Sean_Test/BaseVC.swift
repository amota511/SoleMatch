...
class BaseVC: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        selectionView.frame.size.height = 1.5
        selectionView.frame.size.width = self.view.frame.width / 2.25
        selectionView.center.x = self.view.center.x
        selectionView.frame.origin.y = (self.view.frame.height / 11) - 2.5
    ...
    func scrollLeft(){
        ...
        UIView.animate(withDuration: 0.5) {
            self.selectionView.frame.origin.x = 6
            self.selectionView.frame.size.width = self.leftButton.frame.width * 1.25
        }
    ...
    func scrollCenter(){
        ...
        UIView.animate(withDuration: 0.5) {
            self.selectionView.frame.size.width = self.view.frame.width / 2.25
            self.selectionView.center.x = self.view.center.x
    ...
    func scrollRight(){
        ...
        UIView.animate(withDuration: 0.5) {
            self.selectionView.frame.size.width = self.rightButton.frame.width * 1.25
            self.selectionView.frame.origin.x = self.view.frame.width - self.rightButton.frame.width - 18
    ...
    func showAddSneakerViewController() {
